      ...
      >
        ...
        >
          ...
          <MagneticButton variant="heroOutline" size="lg" asChild>
            <a href="/resume/dinesh-resume.pdf" target="_blank" rel="noopener noreferrer">View Resume</a>
          </MagneticButton>
          <MagneticButton variant="heroOutline" size="lg" asChild>
            <a href="/resume/dinesh-resume.pdf" download="Dinesh_Resume.pdf">Download Resume</a>
          </MagneticButton>
          <MagneticButton variant="hero" size="lg" asChild>
