...
const techCategories = [
  ...
  {
    category: 'Frontend',
    technologies: ['React', 'HTML', 'CSS', 'Responsive UI'],
  },
  {
    category: 'Backend',
    technologies: ['Node.js', 'Express', 'Flask'],
  },
  {
    category: 'AI / ML',
    technologies: ['Machine Learning Integration', 'Recommendation Systems'],
  },
  {
    category: 'Security',
    technologies: ['JWT Authentication', 'Role-Based Access Control'],
  },
  {
    category: 'Database System',
    technologies: ['SQL', 'SQL.js'],
  },
  {
    category: 'Tools',
  ...
  },
  {
    ...
    technologies: ['MS Word', 'Excel', 'PowerPoint', 'Power BI'],
  },
];
