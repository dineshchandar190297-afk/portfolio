  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'mailformedineshc@gmail.com',
      href: 'mailto:mailformedineshc@gmail.com',
    },
    {
      icon: MapPin,
      label: 'Location',
  ...
  const socialLinks = [
    {
      icon: Linkedin,
      label: 'LinkedIn',
      href: 'https://linkedin.com/in/cdinesh-10947a341',
    },
  ];
      ...
      <div className="container-main relative z-10" ref={ref}>
        ...
        >
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Dinesh C. Built with precision.
          </p>
        </motion.footer>
      </div>
    </section>
